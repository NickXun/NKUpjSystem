var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var name="comment"+aData[1];
            var buttonId="reply"+aData[1];
            var replyForm="<textarea type='text' style='width:400px' name="+name+"></textarea><br><button id="+buttonId+">确认</button>";
            var reply=(aData[4]!='no')?aData[4]:replyForm;
            var sOut = '<table>';
            sOut += '<tr><td>ID:</td><td>'+aData[1]+'</td></tr>';
            sOut += '<tr><td>姓名:</td><td>'+aData[2]+'</td></tr>';
            sOut += '<tr><td>评论:</td><td>'+aData[3]+'</td></tr>';
            sOut += '<tr><td>回复:</td><td>'+reply+'</td></tr>';
            //sOut += '<tr><td>确认:</td><td>Could provide a link here</td></tr>';
            sOut += '</table>';
